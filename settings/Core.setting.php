...
return [
  ...
  'contact_test_entities' => [
    'group_name' => 'CiviCRM Preferences',
    'group' => 'core',
    'name' => 'contact_test_entities',
    'type' => 'Integer',
    'html_type' => 'radio',
    'default' => CRM_Core_TestEntity::TEST_AND_LIVE,
    'add' => '5.13',
    'title' => ts('Test Mode'),
    'is_domain' => 1,
    'is_contact' => 1,
    'description' => NULL,
    'help_text' => NULL,
    'options' => [CRM_Core_TestEntity::LIVE_ONLY => ts('Live only'), CRM_Core_TestEntity::TEST_ONLY => ts('Test only'), CRM_Core_TestEntity::TEST_AND_LIVE => ts('Test and Live')],
  ],
];
