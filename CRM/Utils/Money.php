...
class CRM_Utils_Money {
  ...
  public static function format($amount, $currency = NULL, $format = NULL, $onlyNumber = FALSE, $valueFormat = NULL) {
    ...
    $moneyAmount = Money::of($amount, $currency, NULL, RoundingMode::CEILING);
  ...
  private static function getCurrency($currency) {
    ...
    if (strpos($currency, ',') !== FALSE) {
      // Multicurrency batches return a comma separated list of currencies in CRM_Batch_BAO_Batch::getBatchList())
      $currency = NULL;
    }
